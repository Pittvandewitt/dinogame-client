...
Runner.prototype = {
  ...
  */
  loadImages: function () {
    ...
    for (var i = numImages - 1; i >= 0; i--) {
      ...
      imgObject.src = imgSource.id
      this.images[imgSource.name] = imgObject
    }
    this.init();
  },
  /**
  ...
  loadSounds: function () {
    if (!IS_IOS) {
      ...
      for (var sound in Runner.sounds) {
        var soundSrc = Runner.sounds[sound];
        soundSrc = soundSrc.substr(soundSrc.indexOf(',') + 1);
        // var soundSrc = Runner.sounds[sound].src
  ...
  */
  gameOver: function () {
    ...
    // Upload score
    const highScoreStr = this.distanceMeter.getActualDistance(this.distanceRan)
    const state = store.getState()
    request.post(`${URL}/score`)
      .set('Authorization', `Bearer ${state.player.jwt}`)
      .send({ score: highScoreStr, playerId: state.player.id })
